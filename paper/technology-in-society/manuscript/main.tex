...
\item Dark patterns collapse trust even at low intensity, while revenue stays near control.
...
% =====================================================================
% Author Vitae (max 100 words each, per journal guide)
% =====================================================================

\bio{}
\textbf{Darko Etinger} is an Associate Professor of Informatics and Dean of the Faculty of Informatics at the Juraj Dobrila University of Pula, Croatia. His research focuses on business process management, modeling and simulation, artificial intelligence, digital transformation, and information systems. He has authored numerous scientific publications and actively serves as a reviewer, guest editor, and member of international conference committees. His current work explores AI-driven decision support, autonomous AI agents, process mining, and the application of systems thinking to complex organizational challenges. He is a member of IEEE, ACM, and the Croatian Operational Research Society.
\endbio

\bio{}
\textbf{Dejana Pivac} has been with Infobip, Zagreb, Croatia, since 2025, initially as a Software Engineering Intern and currently as a Software Engineer, specializing in backend software development. She received the B.S.\ degree in Informatics from the Faculty of Informatics, Juraj Dobrila University of Pula, Pula, Croatia, in 2022 and is currently pursuing the M.S.\ degree in Informatics at the same institution under the supervision of Darko Etinger. Her research interests include software engineering, agent-based modeling and simulation, computational social science, and the design and governance of AI-enabled digital platforms.
\endbio
